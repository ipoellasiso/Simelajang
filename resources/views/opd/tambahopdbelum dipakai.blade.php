                ...
                <div class="card xl:col-span-2">
                  <div class="card-body flex flex-col p-6">
                    <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                      <div class="flex-1">
                        <div class="card-title text-slate-900 dark:text-white">Tambah Data OPD</div>
                      </div>
                    </header>
                      ...
                      <form class="space-y-4" id="typeValidation">
                        <div class="grid md:grid-cols-2 gap-7">
                          <div class="input-area">
                            ...
                            <input id="name_opd" name="name_opd" type="text" class="form-control" placeholder="nama">
                          </div>
                          <div class="input-area">
                            <label for="number" class="form-label">Must Only Consist Of Numbers</label>
                            <input id="number" name="number" type="text" class="form-control" placeholder="Enter Number only">
                          </div>
                          <div class="input-area">
                            <label for="rangeType" class="form-label">Range Value</label>
                            <input id="rangeType" name="rangeType" type="number" class="form-control" placeholder="Enter number from 0 to 50">
                          </div>
                          <div class="input-area">
                            <label for="alphabeticCharacter" class="form-label">Alphabetic Characters</label>
                            <input id="alphabeticCharacter" name="alphabeticCharacter" type="text" class="form-control" placeholder="Enter Character Only">
                          </div>
                        </div>
