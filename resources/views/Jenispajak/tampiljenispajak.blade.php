                  ...
                  <div class=" space-y-5">
                    <div class="card">
                      <header class=" card-header noborder">
                        <h4 class="card-title">Data Jenis Pajak
                        </h4>
                          ...
                          <div class="inline-block min-w-full align-middle">
                            <div class="overflow-hidden ">
                              ...
                              <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700 data-table">
                                ...
                                <?php $i=1; ?>
                                @foreach ($datajenispajak as $item)
                                    <td class="table-td"> {{ $i++ }}</td>
                                    <td class="table-td">{{ $item->jenis_pajak }}</td>
                                    <td class="table-td">{{ $item->id_akun_pajak }}</td>
                                          ...
                                          <td class="table-td ">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                ...
                                                <a class="action-btn" data-jenispajak="{{ $item->id }}" id="deletejenispajak">
                                                    <button type="submit" class="action-btn">
                                                        <iconify-icon icon="heroicons:trash"></iconify-icon>
                                                    </button>
                                                </a>
                                              
                                                <button type="button" class="action-btn" id="btn-edit-jenispajak"
                                                    data-bs-toggle="modal" data-bs-target="#edit_modal"
                                                    data-id = "{{ $item->id }}"
                                                    data-jenis_pajak = "{{ $item->jenis_pajak }}"
                                                    data-id_akun_pajak = "{{ $item->id_akun_pajak }}"
                                                    >
          ...
          <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-600 bg-secondary-500">
            ...
            <button type="button" class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center
              ...
              <span class="sr-only">Close modal</span>
                ...
                <form method="post"a action="{{ route('simpanjenispajak') }}">
                @csrf
                  ...
                  <div class="card-body flex flex-col p-6">
                      ...
                      <div class="card-text h-full space-y-4">
                            ...
                            <div class="input-area" required>
                                ...
                                <input id="jenis_pajak" name="jenis_pajak" type="text" class="form-control" placeholder="jenis_pajak" required>
                            </div>

                            <div class="input-area" required>
                              <label class="form-label">Akun Pajak</label>
                              <input id="id_akun_pajak" name="id_akun_pajak" type="text" class="form-control" placeholder="id_akun_pajak" required>
                          </div>
          ...
          <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-600 bg-secondary-500">
            ...
            <button type="button" class="text-slate-400 bg-transparent hover:text-slate-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center
              ...
              <span class="sr-only">Close modal</span>
                ...
                <form method="post"a action="{{ route('editjenispajak', $item->id) }}">
                  @method('post')
                  @csrf
                <div class="card">
                  <div class="card-body flex flex-col p-6">
                    ...
                    <div class="card-text h-full space-y-4">
                      ...
                      <div class="card-text h-full space-y-4">
                              ...
                              <div class="input-area">
                                  <label class="form-label">Akun Pajak</label>
                                  <input name="id_akun_pajak" type="text" class="form-control" id="edit-id_akun_pajak">
                              </div>
                        </div>
                      </div>
                      </div>
...
<!-- END: Dashboard Tengah -->
  ...
  <script>
    $(document).on('click', '#btn-edit-jenispajak', function(){
        let id = $(this).data('id');
        let jenis_pajak = $(this).data('jenis_pajak');
        let id_akun_pajak = $(this).data('id_akun_pajak');
  
        $('#edit-id').val(id);
        $('#edit-jenis_pajak').val(jenis_pajak);
        $('#edit-id_akun_pajak').val(id_akun_pajak);
