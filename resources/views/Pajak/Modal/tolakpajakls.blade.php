        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
          ...
          <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-slate-600 bg-secondary-500">
            ...
            <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                <button data-bs-dismiss="modal" class="btn inline-flex justify-center text-white bg-black-500 scale" data-tippy-content="tolak" data-tippy-theme="danger" type="submit">Ya</button>
            </div>
          </form>
