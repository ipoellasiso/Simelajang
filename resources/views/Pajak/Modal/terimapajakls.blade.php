              ...
              <span class="sr-only">Close modal</span>
                ...
                <form method="post"a action="{{ route('updateterima-pajakls', $item->id) }}">
                  ...
                  <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                      <button data-bs-dismiss="modal" class="btn inline-flex justify-center text-white bg-black-500 scale" data-tippy-content="Terima" data-tippy-theme="dark" type="submit">YA</button>
                  </div>
              </form>
        </div>
      </div>
