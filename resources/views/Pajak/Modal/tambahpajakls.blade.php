        ...
        {{-- // --}}
          ...
          <form class="space-y-4" method="post"a action="{{ route('editpajakls', $item->id) }}">
            ...
            <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                <button data-bs-dismiss="modal" class="btn inline-flex justify-center text-white bg-black-500 scale" data-tippy-content="simpan" data-tippy-theme="success" type="submit">Tambahkan</button>
            </div>
          </form>
          </div>
      </div>
