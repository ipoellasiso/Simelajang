                                ...
                                <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                    <thead class="bg-slate-200 dark:bg-slate-700">
                                      <tr>
                                        ...
                                        <th scope="col" class=" table-th ">NILAI SP2D</th>
                                    ...
                                    <body>
                                      ...
                                      @foreach ($sp2dgu as $row) 
                                        <tr class="hover:bg-slate-200 dark:hover:bg-slate-700">
                                          ...
                                          <td class="table-td">{{ rupiahha($row['nilai_sp_2_d']) }}</td>
                                                    ...
                                                    <td class="table-td ">
                                                      ...
                                                      ?>
                                                          <a href="{{ route('simpansp2dgusipdri') }}?id=<?= $row['id_sp_2_d']; ?>" class="action-btn scale btn inline-flex justify-center btn-outline-primary mr-3" data-tippy-content="Simpan Data" data-tippy-theme="secondary" type="button"><iconify-icon icon="ic:round-file-download"></iconify-icon>
                                                          </a>
                                                      <?php  
                                                            }
                                                      ?>
                                    ...
                                    <nav aria-label="Page navigation example">
                                      <ul class="pagination justify-content-center">
                                        ...
                                        <?php
                                          ...
                                          {
                                            ?>
                                            <li class="page-item"><a class="page-link" href="tampilsp2dgusipdri?id=<?=$a;?>"><?=$a;?></a></li>
                                          <?php 
                                            }
                                          ?>
                                        <li class="page-item">
                                          <a class="page-link" href="tampilsp2dgusipdri?id=<?=$a;?>" aria-label="Next">
