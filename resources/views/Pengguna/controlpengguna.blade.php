...
<body class=" font-inter dashcode-app" id="body_class">
                    ...
                    <div class="card">
                      <header class=" card-header noborder">
                        ...
                        @if (auth()->user()->role=="admin")
                          <a href="{{ route('registrasi') }}" class="btn inline-flex justify-center btn-light btn-sm">Tambah Data</a>
                        @endif
                      </header>
                                    ...
                                    <td class="table-td">{{ $item->role }}</td>
                                          ...
                                          <td class="table-td ">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                ...
                                                <a class="action-btn swal-confirm" data-id="{{ $item->id }}">
                                                    <button type="submit" class="action-btn">
                                                        <iconify-icon icon="heroicons:trash"></iconify-icon>
                                                    </button>
                                                </a>

                                                <a href="#" class="action-btn" data-bs-toggle="modal" data-bs-target="#large_modal{{ $item->id }}">
  ...
  {{-- #################################################################################################################### --}}
  {{-- modal edit --}}
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="large_modal{{ $item->id }}" tabindex="-1" aria-labelledby="large_modal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                    ...
                    <div class="card">
                        <div class="card-body flex flex-col p-6">
                            ...
                            <div class="card-text h-full space-y-4">
                                ...
                                {{-- <input name="fullname" id="fullname" type="text" class="form-control" placeholder="Name"> --}}
                                {{-- {!! user::text('fullname', $item->fullname, array('placeholder' => 'fullname','class' => 'form-control')) !!}
                                </div> --}}

                                {{-- <div class="card-text h-full space-y-4">
                                <div class="input-area">
                                    <label for="name" class="form-label">Email</label>
                                    <input id="name" name="email" type="text" class="form-control" placeholder="Project Name">
                                </div>

                                <div class="card-text h-full space-y-4">
                                    <div class="input-area">
                                        <label for="name" class="form-label">Password</label>
                                        <input id="name" name="password" type="text" class="form-control" placeholder="Project Name">
                                </div>

                                <div class="card-text h-full space-y-4">
                                    <div class="input-area">
                                        <label for="name" class="form-label">Opd</label>
                                        <input id="name" name="id_opd" type="text" class="form-control" placeholder="Project Name">
                                </div> --}}

                                <div class="input-area">
                                <label for="select" class="form-label">Role</label>
                                <select id="select" class="form-control">
                                    <option value="option1" class="dark:bg-slate-700">admin</option>
                                    <option value="option2" class="dark:bg-slate-700">user</option>
                                </select>
                                </div>
                            ...
                            <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                                <button data-bs-dismiss="modal" class="btn inline-flex justify-center text-white bg-black-500" type="submit" name="updatepengguna">Simpan</button>
                            </div>
                {{-- </form> --}}
